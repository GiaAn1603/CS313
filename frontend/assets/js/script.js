  ...
  cardContainer.innerHTML = `
    <div class="col-12 col-md-4">
      <div class="details-card rounded-4 overflow-hidden">
        <div class="card-header d-flex align-items-center justify-content-between py-3 px-5">
          <p class="day mb-0">
            ${new Date(weather.forecast.forecastday[0].date).toLocaleDateString("en-US", {
              weekday: "long",
            })}
          </p>
          <p class="date mb-0">
    ...
    <div class="col-12 col-md-4">
      <div class="details-card rounded-4 overflow-hidden">
        <div class="card-header d-flex align-items-center justify-content-between py-3 px-5">
          <p class="day mb-0">
            ${new Date(weather.forecast.forecastday[1].date).toLocaleDateString("en-US", {
              weekday: "long",
            })}
          </p>
          <p class="date mb-0">
    ...
    <div class="col-12 col-md-4">
      <div class="details-card rounded-4 overflow-hidden">
        <div class="card-header d-flex align-items-center justify-content-between py-3 px-5">
          <p class="day mb-0">
            ${new Date(weather.forecast.forecastday[2].date).toLocaleDateString("en-US", {
              weekday: "long",
            })}
          </p>
          <p class="date mb-0">
